//Class WeatherDataComponent handels reading from SMHI's API,
//storing and printing of the data. WeatherSet is a structure
//which is used when storing the data in a list in WeatherDataComponent. 
...
/// Reads weather data from SMHI's API.
/// Stores weatherparameters in a list of [WeatherSet].
/// Right now it also draws a timeline with data printed from the WeatherSet-list.
class WeatherDataComponent {
  ...
  WeatherDataComponent() {
    //Uncomment the following line when compiling to JavaScript.
  ...
  //Load data and call all other functions that process the data.
  void _loadData() {
    print("Loading data");

    //Create URL to SMHI's API with longitude and latitude values.
    ...
    //Function that calls SMHI's API.
  ...
  //Uses other functions to set all parameters of a WeatherSet.
  ...
  //Categorize a weatherset depending on time 
  ...
  void drawCanvas(){
    ...
    //Formatting the time so 17:9 -> 17:09.
...
///Structure for storing weather parameters
class WeatherSet {
  double temp;
